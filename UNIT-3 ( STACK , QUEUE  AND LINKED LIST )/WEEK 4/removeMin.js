...
// You are given the head of the linked list, you need to remove the minimum element in the 
//linked list and return the head of the changed linked list.
