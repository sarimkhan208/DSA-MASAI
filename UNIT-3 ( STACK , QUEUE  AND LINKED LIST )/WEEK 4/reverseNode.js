// Reverse the Linked List -33:50:2
// Description

// Given the pointer to the head node of a linked list, change thepointers of the 
// nodes so that their order is reversed. The head pointer given may be null meaning that 
