...
// The next line contains another N space separated integers, denoting the ideal order in 
// which they should be condcuted.
...
// There are3 processes, the calling order of the processes is:3 - 2 - 1.The ideal order is:1 - 3 - 2,i.e., 
// process number 3 will only be executed after process number 1 has been completed; process number 2 
...
// i.e., the first element has to be pushed to the last place. Changing the position of the element takes 1 
// unit of time. The new calling order is: 2 - 1 - 3. Time taken in step #1: 1.

// Iteration #2:Since the ideal order has process #1 to be executed firstly, the calling ordered has to be
//  changed again, i.e., the first element has to be pushed to the last place. The new calling order is: 1 - 3 - 2. Time taken in step #2: 1.
...
// Iteration #4:Since the new first element of the calling order is same as the ideal order, that process will 
// be executed. Time taken in step #4: 1.

// Iteration #5:Since the last element of the calling order is same as the ideal order, that process will be 
// executed. Time taken in step #5: 1.

// Total time taken: 5 units.

let arr1 = [3,2,1] , arr2 = [1,3,2] , n=3
myfun(n,arr1,arr2)
