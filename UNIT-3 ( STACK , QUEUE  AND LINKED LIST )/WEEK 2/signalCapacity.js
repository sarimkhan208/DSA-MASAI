...
// Tower X shall block the signal of Tower Y if Tower X is present to the left of 
// Tower Y and Tower X is taller than Tower Y. So,the power of a signal of a given tower can be defined as :
...
let arr = [100,80,60,70,60,75,85] , n = arr.length
myfun(arr,n)
