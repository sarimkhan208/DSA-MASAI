...
// Indexing is 0 based indexing. If multiple solutions exist, output the one with 
// the lowest values of a and b.
...
let arr=[2,7,11,15],n=4,p=9
myfun(arr,n,p)
function myfun(arr,n,p){
    let flag=false
    for(let i=0; i<n; i++){
        for(let j=0; j<n; j++){
