...
// Description
// Given arrival and departure times of all trains that reach a railway stati
// on, the task is to find the minimum number of platforms required for th
// e railway station so that no train waits
// 
